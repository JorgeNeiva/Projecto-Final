        ...
        <div>
          ...
          <div className="map">
            ...
            <form className="formulario">
                  <label> Sabe mais sobre nós
                       <input type="text" name="name" placeholder="O teu nome" />
                       <input type="text" name="name" placeholder="O teu e-mail" />
                  </label>
                  <input type="submit" value="Quero mais informação" />
            </form> 
            <div>
              <h2>Segue-nos nas redes sociais</h2>
              <button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
